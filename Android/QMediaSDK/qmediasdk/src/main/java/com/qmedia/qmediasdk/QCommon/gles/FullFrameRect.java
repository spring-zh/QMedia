...
public class FullFrameRect {
    ...
    public FullFrameRect(Texture2dProgram program, int type) {
        switch (type) {
            case 1:
                mRectDrawable = new Drawable2d(Drawable2d.Prefab.RECTANGLE);
                break;
            case 2:
                mRectDrawable = new Drawable2d(Drawable2d.Prefab.RECTANGLE2);
                break;
        }
    ...
    public FullFrameRect(Texture2dProgram program) {
        mRectDrawable = new Drawable2d(Drawable2d.Prefab.FULL_RECTANGLE_FLIP);
        mProgram = program;
    }
