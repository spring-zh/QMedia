 ...
 * using the {@link #setRenderer(GLSurfaceView14.Renderer)} call.
 * <p>
 * <h3>Initializing GLSurfaceView</h3>
 * All you have to do to initialize a GLSurfaceView is call {@link #setRenderer(GLSurfaceView14.Renderer)}.
 * However, if desired, you can modify the default behavior of GLSurfaceView by calling one or
 * more of these methods before calling setRenderer:
 * <ul>
 * <li>{@link #setDebugFlags(int)}
 * <li>{@link #setEGLConfigChooser(boolean)}
 * <li>{@link #setEGLConfigChooser(GLSurfaceView14.EGLConfigChooser)}
 ...
 * Finally, you must call {@link #setRenderer} to register a {@link GLSurfaceView14.Renderer}.
 * The renderer is
 ...
 *
 */
public class GLSurfaceView14 extends SurfaceView implements SurfaceHolder.Callback2 {
     ...
     */
    public GLSurfaceView14(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public GLSurfaceView14(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     */
    public void setRenderer(GLSurfaceView14.Renderer renderer) {
     ...
     * <p>If this method is
     * called, it must be called before {@link #setRenderer(GLSurfaceView14.Renderer)}
     * is called.
     * <p>
     ...
     */
    public void setEGLContextFactory(GLSurfaceView14.EGLContextFactory factory) {
        checkRenderThreadState();
     ...
     */
    public void setEGLWindowSurfaceFactory(GLSurfaceView14.EGLWindowSurfaceFactory factory) {
        checkRenderThreadState();
     ...
     * @param configChooser
     */
    public void setEGLConfigChooser(GLSurfaceView14.EGLConfigChooser configChooser) {
        checkRenderThreadState();
     ...
     * <p>If this method is called, it must be called before {@link #setRenderer(GLSurfaceView14.Renderer)}
     * is called.
     * <p>This method only affects the behavior of the default EGLContexFactory and the
     * default EGLConfigChooser. If
     * {@link #setEGLContextFactory(GLSurfaceView14.EGLContextFactory)} has been called, then the supplied
     * EGLContextFactory is responsible for creating an OpenGL ES 2.0-compatible context.
     * If
     * {@link #setEGLConfigChooser(GLSurfaceView14.EGLConfigChooser)} has been called, then the supplied
     ...
     * <p>
     * This method can only be called after {@link #setRenderer(GLSurfaceView14.Renderer)}
     *
     ...
     * this interface, and then call {@link GLSurfaceView14#setRenderer} to
     ...
     * use the {@link GLSurfaceView14#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     *
     *
     * @see #setRenderer(GLSurfaceView14.Renderer)
     */
     ...
     * {@link GLSurfaceView14#setEGLContextFactory(GLSurfaceView14.EGLContextFactory)}
     */
    ...
    private class DefaultContextFactory implements GLSurfaceView14.EGLContextFactory {
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLSurfaceView14#setEGLWindowSurfaceFactory(GLSurfaceView14.EGLWindowSurfaceFactory)}
     */
    ...
    private static class DefaultWindowSurfaceFactory implements GLSurfaceView14.EGLWindowSurfaceFactory {
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLSurfaceView14#setEGLConfigChooser(GLSurfaceView14.EGLConfigChooser)}
     */
    ...
    private abstract class BaseConfigChooser
            implements GLSurfaceView14.EGLConfigChooser {
...
//            }
            EGLConfig[] configs = new EGLConfig[/*numConfigs*/1];
            if (!EGL14.eglChooseConfig(display, mConfigSpec, 0, configs, 0, configs.length/*numConfigs*/,
                    num_config, 0)) {
...
//                    EGL_RECORDABLE_ANDROID, 1,
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<GLSurfaceView14> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            GLSurfaceView14 view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        private WeakReference<GLSurfaceView14> mGLSurfaceViewWeakRef;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<GLSurfaceView14> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
        ...
        private void guardedRun() throws InterruptedException {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (createEglContext) {
                        ...
                        if (view != null) {
                            try {
                                ...
                                view.mRenderer.onSurfaceCreated(mEglHelper.mEglConfig);
                            } finally {
                                Trace.endSection();
                            }
                        }
                    ...
                    {
                        boolean drawRet = false;

                        GLSurfaceView14 view = mGLSurfaceViewWeakRef.get();
                        if (view != null) {
                            try {
                                Trace.beginSection("onDrawFrame");
                                drawRet = view.mRenderer.onDrawFrame();
                            } finally {
                                Trace.endSection();
                            }
                        }
    ...
    private final WeakReference<GLSurfaceView14> mThisWeakRef =
            new WeakReference<GLSurfaceView14>(this);
    private GLThread mGLThread;
    private GLSurfaceView14.Renderer mRenderer;
    private boolean mDetached;
    private GLSurfaceView14.EGLConfigChooser mEGLConfigChooser;
    private GLSurfaceView14.EGLContextFactory mEGLContextFactory;
    private GLSurfaceView14.EGLWindowSurfaceFactory mEGLWindowSurfaceFactory;
