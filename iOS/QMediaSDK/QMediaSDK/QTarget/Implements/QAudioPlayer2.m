...
static void AudioQueueOuptutCallback(void * inUserData, AudioQueueRef inAQ, AudioQueueBufferRef inBuffer) {
    QAudioPlayer2 *audioPlayer = (__bridge QAudioPlayer2 *)(inUserData);
    id<QAudioRender2> audioRender = audioPlayer.audioRender;
    if (audioRender != nil)
    {
