...
#ifdef __cplusplus
    #define NS_CC_MATH_BEGIN                     namespace QMedia { namespace RenderEngine  {
    #define NS_CC_MATH_END                       }}
    #define USING_NS_CC_MATH                     using namespace QMedia::RenderEngine
    #define NS_CC_BEGIN                     namespace QMedia { namespace RenderEngine  {
    #define NS_CC_END                       }}
    #define USING_NS_CC                     using namespace QMedia::RenderEngine
#else
