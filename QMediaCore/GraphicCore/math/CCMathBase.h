...
#ifdef __cplusplus
    #define NS_CC_MATH_BEGIN                     namespace GraphicCore {
    #define NS_CC_MATH_END                       }
    #define USING_NS_CC_MATH                     using namespace GraphicCore
    #define NS_CC_BEGIN                     namespace GraphicCore {
    #define NS_CC_END                       }
    #define USING_NS_CC                     using namespace GraphicCore
#else
